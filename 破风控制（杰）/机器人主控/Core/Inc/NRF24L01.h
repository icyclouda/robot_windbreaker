...
//NRF2401片选信号
#define Clr_NRF24L01_CE      HAL_GPIO_WritePin(CE_nrf24l01_GPIO_Port, CE_nrf24l01_Pin, GPIO_PIN_RESET)
#define Set_NRF24L01_CE      HAL_GPIO_WritePin(CE_nrf24l01_GPIO_Port, CE_nrf24l01_Pin, GPIO_PIN_SET)

//SPI片选信号
#define Clr_NRF24L01_CSN     HAL_GPIO_WritePin(CSN_nrf24l01_GPIO_Port, CSN_nrf24l01_Pin, GPIO_PIN_RESET)
#define Set_NRF24L01_CSN     HAL_GPIO_WritePin(CSN_nrf24l01_GPIO_Port, CSN_nrf24l01_Pin, GPIO_PIN_SET)

//NRF2401_IRQ数据输入
#define READ_NRF24L01_IRQ   HAL_GPIO_ReadPin(IRQ_nrf24l01_GPIO_Port, IRQ_nrf24l01_Pin)
